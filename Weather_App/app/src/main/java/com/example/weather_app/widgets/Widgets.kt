...
fun WeatherDetailedRow(weather: WeatherItem) {
    ...
    Surface(
        ...
        Row(
            ...
            Text(text = "${formatDate(weather.dt).split(", ")}",
...
fun SunsetSunriseRow(weather: Weather) {
    Row(
        ...
        Row(
            ...
            Icon(painter = painterResource(id = R.drawable.sunrise ), contentDescription = "sunrize icon",
    ...
    Row(modifier = Modifier
        ...
        Row(
            ...
            Icon(painter = painterResource(id = R.drawable.pressure ), contentDescription = "pressure icon",
                modifier = Modifier.size(20.dp))
            Text(text = "${weather.main.humidity} psi",
                style = MaterialTheme.typography.caption
            )
        }
        Row(
